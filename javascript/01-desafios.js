...
/*crear una funcion llamada presentarme,
 dentro crear una variable y asiganerle 
 su nombre, crear una constante y asignarle 
 su edad, luego imprimir en consola: hola, 
 soy - y tengo- años*/
...
/* crear una funcion que reciba un nombre 
y edad por parametros, luego imprimir 
en consola hola, soy - y tengo - años*/
...
/* crear una funcion que reciba nombre, 
 apellido y una edad por parametros, 
la funcion debe imprimir en consola: 
 su nombre es --- y usted tiene --- años. 
si no se recibe la edad imprimir: su nombre 
es ---- y usted tiene 100 años.*/
